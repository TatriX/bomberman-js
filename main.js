...
function Player(computer){
    ...
    this.draw = function(){
        ...
        if(!this.computer){
            ...
            game.ui.append("<span style='color: red'>Lifes</span>", this.lifes);
            game.ui.append("<span>Bombs</span>", this.bombs);
            game.ui.append("<span style='color:purple'>Enemies</span>", mobs.length);
            game.ui.append("<b>Bonuses</b>", "");
        }
        if(this.dead){
            this.lifes--;
            if(this.lifes == 0){
                ...
                print('Dead!<br>Lifes left: ' + this.lifes, 2000);
                this.dead = false;
                this.immune = true;
                player.x = 0;
                player.y = 0;
        ...
        function check(w, h){
            ...
            case "exit":
                ...
                var id = print("Next level!<br>" + ++game.level + "!");
...
function start(){
    ...
    game.frame = 0;
    game.fps = 25;
    //requestanimationframe не очень 8(
